...
GL.texImage2D(GL.TEXTURE_2D, 0, GL.RGBA, GL.RGBA, GL.UNSIGNED_BYTE, document.getElementById('boxImage'));
}
...
function SendDataToShaders(){
    ...
    GL.vertexAttribPointer(vertexPositionAttributeLocation, 3, GL.FLOAT, false, 5 * Float32Array.BYTES_PER_ELEMENT, 0);
